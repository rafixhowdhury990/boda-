...
print('')
print('')
print(' \033[38;5;46m SC MAKE BY RAFI XHOWDHURY \n  Github: rafixhowdhury990')
try:
    import requests
...
..:::::..::..:::::..:::::..:::::..::..:::::..::..::::::::....::
 ...
 \033[38;5;6m╔════════════════════════════════════════════════╗
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;146mRAFI XHOWDHURY   \033[38;5;6m║
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mFACEBOK      \033[38;5;196m: \033[38;5;146mARIYAN RAFI                 \033[38;5;6m║
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;146m rafixhowdhury990              \033[38;5;6m║
 ...
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mTEAM         \033[38;5;196m:  \033[38;5;146mRafi Cyber-101                    \033[38;5;6m║
 ...
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m RAF TERMUX HELPING ZONE....
 \033[38;5;6m══════════════════════════════════════════════════
    """)
...
def meyexudi():
  ...
  try:
    if id in httpCaht:
      ...
      tks = ('Hi'+id);os.system('am start https://wa.me/+8801301668047?text='+tks),()
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
def Heda():
        ...
        print(balpakna)
        RAFI =input(" \033[38;5;195m[•] \033[1;92m Choose\033[1;91m : \033[1;92m")
        if RAFI in ["1","01"]:
            fuck()
        if RAFI in ["2","02"]:
        	habibi()
...
def samiya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :rafi = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :rafi = ' • 2009'
        elif uid[:8] in ['10000000']        :rafi = ' • 2009'
        ...
        elif uid[:6] in ['100001']          :rafi = ' • 2010/2011'
        elif uid[:6] in ['100002','100003'] :rafi = ' • 2011/2012'
...
def fuck():
    ...
    #print(' [✓] Ids saved in RAFI-OK.txt,-CP.txt')
    #print(balpakna)
